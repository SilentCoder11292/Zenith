      ...
      >
        ...
        <div className="flex items-center justify-between pb-4 border-b border-[#E5E5E5] dark:border-[#222222] mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-bold text-[#111111] dark:text-[#F5F5F5]">Edit Asset Footprint</h3>
              <p className="text-[10px] text-slate-400 dark:text-slate-500">Update coordinates and metrics mapping</p>
            </div>
          </div>
          <button 
            onClick={onClose}
